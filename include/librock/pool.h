...
typedef rk_id_t (*rk_pool_new_t)(rk_pool_t *pl, const void *dptr, size_t len,
                                 rk_status_t *err);
...
typedef size_t (*rk_pool_get_size_t)(rk_pool_t *pl, rk_id_t id,
                                     rk_status_t *err);
...
// vt wrappers
rk_id_t rk_pool_new(rk_pool_t *pl, const void *dptr, size_t len,
                    rk_status_t *err);
void rk_pool_delete(rk_pool_t *pl, rk_id_t id, rk_status_t *err);
void rk_pool_resize(rk_pool_t *pl, rk_id_t id, size_t new_size,
                    rk_status_t *err);
